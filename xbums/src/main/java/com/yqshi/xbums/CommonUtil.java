...
class CommonUtil {
     ...
     * 在url当中拼接几个公共参数
     */
    public static String assemParamsUrl(Context context, String mUrl) {
        ...
        if (CommonUtil.isSupportlocation(context)) {
            encodedParams.append("&")
                    .append("tj_lat").append("=").append(DeviceInfo.getLatitude())
                    .append("&")
                    .append("tj_lng").append("=").append(DeviceInfo.getLongitude());
        }
        mUrl = mUrl + encodedParams.toString();
        return mUrl;
    }
